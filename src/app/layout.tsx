...
import { Unbounded, Space_Grotesk, Space_Mono, Instrument_Serif, Caveat, Titan_One } from "next/font/google";
import "./globals.css";
...
const DESCRIPTION =
  "Describe an object in a sentence, and Archie builds it — real, manufacturable geometry verified against a native kernel. #2 on CADGenBench, #1 among local models. Studio for 3D creation, Forge for mechanical CAD, Archie the on-device model. Local and private. Public release soon.";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html
      ...
      className={`${unbounded.variable} ${spaceGrotesk.variable} ${spaceMono.variable} ${instrumentSerif.variable} ${caveat.variable} ${titan.variable}`}
    >
